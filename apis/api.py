...
api.add_resource(project_relation.CheckhasSonProject_v2, '/v2/project/<sint:project_id>/has_son')
add_resource(project_relation.CheckhasSonProject_v2,"public")
api.add_resource(project_relation.GetProjectRootID, '/project/<sint:project_id>/root_project')
api.add_resource(project_relation.GetProjectRootID_v2, '/v2/project/<sint:project_id>/root_project')
add_resource(project_relation.GetProjectRootID_v2,"public")
api.add_resource(project_relation.SyncProjectRelation, '/project/sync_project_relation')
api.add_resource(project_relation.SyncProjectRelation_v2, '/v2/project/sync_project_relation')
add_resource(project_relation.SyncProjectRelation_v2,"public")
api.add_resource(project_relation.GetProjectFamilymembersByUser, '/project/<sint:project_id>/members')
api.add_resource(project_relation.GetProjectFamilymembersByUser_v2, '/v2/project/<sint:project_id>/members')
add_resource(project_relation.GetProjectFamilymembersByUser_v2,"public")
