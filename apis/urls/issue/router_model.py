...
class SingleIssuePostSchema(CommonSingleIssueSchema):
    ...
    tracker_id = fields.Int(doc='tracker_id', example=-1, missing=1, required=True)
    status_id = fields.Int(doc='status_id', example=-1, missing=1, required=True)
    priority_id = fields.Int(doc='priority_id', example=-1, missing=1, required=True)
