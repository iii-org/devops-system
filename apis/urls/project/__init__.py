...
def project_url(api, add_resource):
    ...
    api.add_resource(view.ProjectEnvironmentUrlV2,
    ...
    api.add_resource(view.ProjectUserResourceDeployment,
                     '/project/<sint:project_id>/resource/deployments/<deployment_name>')
    api.add_resource(view.ProjectUserResourceDeploymentV2,
    ...
    api.add_resource(view.ProjectUserResourceServiceV2,
