...
class GitLab(object):
    ...
    def create_multiple_file_commit(self, project: objects.Project, files: list[dict[str, str]],
...
def single_file(file_path: str, local_file_path: str,
                action: FileActions = FileActions.CREATE, binary: bool = False) -> dict[str, str]:
    """
