    ...
    def wrapper(*args, **kwargs):
        ...
        if account is None:
            ...
            if refresh_token:
                ...
                resp = make_response()
                resp.set_cookie(TOKEN, access_token, expires=calculate_expired_datetime(access_expires_in_sec))
                resp.set_cookie(
                    REFRESH_TOKEN, refresh_token, expires=calculate_expired_datetime(refresh_expires_in_sec)
                )
...
def calculate_expired_datetime(sec: int):
