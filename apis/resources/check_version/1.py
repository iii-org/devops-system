...
RUNNER_VERSION_MAPPING = {
    "checkmarx": {"answer": COMMON_RUNNER_ANSWERS, "version": "0.2.2"},
    "zap": {"answer": COMMON_RUNNER_ANSWERS | RUNNER_WEB_ANSWERS, "version": "0.2.3"},
    "sideex": {
...
# Image version
IMAGE_VERSION_MAPPING = {"rancher-cli": "1.0.1"}
