...
def router(api, add_resource):
    ...
    api.add_resource(
        sideex_main.SideexJsonfileVariableV2,
        "/v2/sideex/<sint:project_id>/jsonfile/varable",
    )
    add_resource(sideex_main.SideexJsonfileVariableV2, "public")
    api.add_resource(
        sideex_main.SideexGenerateJsonfile,
        "/sideex/<sint:project_id>/jsonfile/generate",
    )
    api.add_resource(
        sideex_main.SideexGenerateJsonfileV2,
        "/v2/sideex/<sint:project_id>/jsonfile/generate",
    )
    ...
    api.add_resource(
        sideex_main.SideexDeleteAllfileV2,
        "/v2/sideex/<sint:project_id>/jsonfile/delete",
    )
