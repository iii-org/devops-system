...
scc_report_data_generator = lambda report_name, project_info: {
    ...
    "inputReportParameters": [
        ...
        {"name": "Include PCI DSS 3.2.1", "identifier": "includePCI321", "paramValue": False, "type": "BOOLEAN"},
        {"name": "Include PCI SSF 1.0", "identifier": "includePCISSF10", "paramValue": False, "type": "BOOLEAN"},
        {"name": "Include CWE", "identifier": "includeCWE", "paramValue": False, "type": "BOOLEAN"},
        {"name": "Include WASC 2.00", "identifier": "includeWASC2", "paramValue": False, "type": "BOOLEAN"},
        {"name": "Include DISA STIG 5.1", "identifier": "includeSTIG51", "paramValue": False, "type": "BOOLEAN"},
...
class WebInspectDownloadReport(Resource):
    @doc(tags=["WebInspect"], description="Download project's WebInspect report.")
